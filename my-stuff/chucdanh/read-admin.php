...
echo "<tbody>";
echo "<thead>";
echo "<th>Họ và tên</th><th>Chức danh</th><th>Thời gian áp dụng</th><th>Duyệt</th>";
echo "</thead>";
...
while ($row = $re->fetch_assoc()) {
		...
		echo '<td><a class="btn btn-info" href="' . home_url('/duyetchucdanh') . '?id=' . $row["id"] . '">Duyệt</a></td>';
		echo '<td><form method="POST" action="' . home_url() . '/my-stuff/chucdanh/update-admin.php?id=' . $row['id'] . '" onsubmit="return confirmRefuse()">
