...
$sql = "SELECT * FROM `CongTrinh_Khac` ct inner join `CanBo_Ctr` cbct on ct.ma_ctr = cbct.ma_ctr where cbct.ma_cb = ".$macb;
...
echo "<tbody>";
echo "<thead>";
echo "<th>Tên đề tài NCKH</th><th>Bắt đầu</th><th>Kết thúc</th><th>Số lượng</th><th>Vị trí</th><th>Trạng thái</th><th>Xem chi tiết</th> <th></th>";
echo "</thead>";
