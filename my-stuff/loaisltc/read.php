...
echo "<tbody>";
echo "<thead>";
echo "<th>Tên đơn vị tính/ mức điểm/giờ chuẩn</th><th>Hệ số</th><th>Thời gian áp dụng</th><th>Update</
th>";
echo "</thead>";
while ($row = $re->fetch_assoc()) {
	if (isset($_GET['id'])) {
		...
		echo '<td><a class="btn btn-info" href="'.$pagename.'?id=' . $row["ma_loaisl"] . '">Update</a></td>';
