...
<div class="wrap">
    <div id="primary" class="content-area">
        ...
        <main id="main" class="site-main">
            ...
            <div class="container">
                <div class="mb-3">Nếu quý thầy/cô đã có thông tin giải thưởng tham gia, vui lòng nhấp vào đây <a href="<?= home_url('/qlytgiagt/') ?>" class="text-decoration-none btn btn-info">Thêm vào danh sách giải thưởng</a></div>
                ...
                <div class="container mt-3">
                    <h2>Thông tin về mã giải thưởng sau khi nhập thành công</h2>
                    <p><?= get_the_content() ?></p>
                    <div id="mess"></div>
                    <div>
...
<script>
    ...
    $("#minhchung").on("click", function(event) {
        event.preventDefault();
